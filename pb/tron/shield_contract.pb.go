...
func (x *AuthenticationPath) Reset() {
	*x = AuthenticationPath{}
	mi := &file_shield_contract_proto_msgTypes[0]
...
func (*AuthenticationPath) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *MerklePath) Reset() {
	*x = MerklePath{}
	mi := &file_shield_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MerklePath) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *OutputPoint) Reset() {
	*x = OutputPoint{}
	mi := &file_shield_contract_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OutputPoint) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *OutputPointInfo) Reset() {
	*x = OutputPointInfo{}
	mi := &file_shield_contract_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OutputPointInfo) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{3}
}
...
func (x *PedersenHash) Reset() {
	*x = PedersenHash{}
	mi := &file_shield_contract_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PedersenHash) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{4}
}
...
func (x *IncrementalMerkleTree) Reset() {
	*x = IncrementalMerkleTree{}
	mi := &file_shield_contract_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IncrementalMerkleTree) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{5}
}
...
func (x *IncrementalMerkleVoucher) Reset() {
	*x = IncrementalMerkleVoucher{}
	mi := &file_shield_contract_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IncrementalMerkleVoucher) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{6}
}
...
func (x *IncrementalMerkleVoucherInfo) Reset() {
	*x = IncrementalMerkleVoucherInfo{}
	mi := &file_shield_contract_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IncrementalMerkleVoucherInfo) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{7}
}
...
func (x *SpendDescription) Reset() {
	*x = SpendDescription{}
	mi := &file_shield_contract_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpendDescription) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{8}
}
...
func (x *ReceiveDescription) Reset() {
	*x = ReceiveDescription{}
	mi := &file_shield_contract_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReceiveDescription) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{9}
}
...
func (x *ShieldedTransferContract) Reset() {
	*x = ShieldedTransferContract{}
	mi := &file_shield_contract_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ShieldedTransferContract) Descriptor() ([]byte, []int) {
	return file_shield_contract_proto_rawDescGZIP(), []int{10}
}
...
var File_shield_contract_proto protoreflect.FileDescriptor

const file_shield_contract_proto_rawDesc = "" +
	"\n" +
	"\x15shield_contract.proto\x12\bprotocol\"*\n" +
	...
	"\tto_amount\x18\a \x01(\x03R\btoAmountB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_shield_contract_proto_rawDescOnce sync.Once
	file_shield_contract_proto_rawDescData []byte
)

func file_shield_contract_proto_rawDescGZIP() []byte {
	file_shield_contract_proto_rawDescOnce.Do(func() {
		file_shield_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shield_contract_proto_rawDesc), len(file_shield_contract_proto_rawDesc)))
	})
	return file_shield_contract_proto_rawDescData
}

var file_shield_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_shield_contract_proto_goTypes = []any{
...
var file_shield_contract_proto_depIdxs = []int32{
...
func init() { file_shield_contract_proto_init() }
func file_shield_contract_proto_init() {
	if File_shield_contract_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shield_contract_proto_rawDesc), len(file_shield_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shield_contract_proto_goTypes,
		DependencyIndexes: file_shield_contract_proto_depIdxs,
		MessageInfos:      file_shield_contract_proto_msgTypes,
	}.Build()
	File_shield_contract_proto = out.File
	file_shield_contract_proto_goTypes = nil
	file_shield_contract_proto_depIdxs = nil
}
