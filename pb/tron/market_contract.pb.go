...
func (x *MarketSellAssetContract) Reset() {
	*x = MarketSellAssetContract{}
	mi := &file_market_contract_proto_msgTypes[0]
...
func (*MarketSellAssetContract) Descriptor() ([]byte, []int) {
	return file_market_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *MarketCancelOrderContract) Reset() {
	*x = MarketCancelOrderContract{}
	mi := &file_market_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MarketCancelOrderContract) Descriptor() ([]byte, []int) {
	return file_market_contract_proto_rawDescGZIP(), []int{1}
}
...
var File_market_contract_proto protoreflect.FileDescriptor

const file_market_contract_proto_rawDesc = "" +
	"\n" +
	"\x15market_contract.proto\x12\bprotocol\"\xe2\x01\n" +
	...
	"\border_id\x18\x02 \x01(\fR\aorderIdB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_market_contract_proto_rawDescOnce sync.Once
	file_market_contract_proto_rawDescData []byte
)

func file_market_contract_proto_rawDescGZIP() []byte {
	file_market_contract_proto_rawDescOnce.Do(func() {
		file_market_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_market_contract_proto_rawDesc), len(file_market_contract_proto_rawDesc)))
	})
	return file_market_contract_proto_rawDescData
}

var file_market_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_market_contract_proto_goTypes = []any{
...
var file_market_contract_proto_depIdxs = []int32{
...
func init() { file_market_contract_proto_init() }
func file_market_contract_proto_init() {
	if File_market_contract_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_market_contract_proto_rawDesc), len(file_market_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_market_contract_proto_goTypes,
		DependencyIndexes: file_market_contract_proto_depIdxs,
		MessageInfos:      file_market_contract_proto_msgTypes,
	}.Build()
	File_market_contract_proto = out.File
	file_market_contract_proto_goTypes = nil
	file_market_contract_proto_depIdxs = nil
}
