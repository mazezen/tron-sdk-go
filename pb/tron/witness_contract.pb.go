...
func (x *WitnessCreateContract) Reset() {
	*x = WitnessCreateContract{}
	mi := &file_witness_contract_proto_msgTypes[0]
...
func (*WitnessCreateContract) Descriptor() ([]byte, []int) {
	return file_witness_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *WitnessUpdateContract) Reset() {
	*x = WitnessUpdateContract{}
	mi := &file_witness_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WitnessUpdateContract) Descriptor() ([]byte, []int) {
	return file_witness_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *VoteWitnessContract) Reset() {
	*x = VoteWitnessContract{}
	mi := &file_witness_contract_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VoteWitnessContract) Descriptor() ([]byte, []int) {
	return file_witness_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *VoteWitnessContract_Vote) Reset() {
	*x = VoteWitnessContract_Vote{}
	mi := &file_witness_contract_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VoteWitnessContract_Vote) Descriptor() ([]byte, []int) {
	return file_witness_contract_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_witness_contract_proto protoreflect.FileDescriptor

const file_witness_contract_proto_rawDesc = "" +
	"\n" +
	"\x16witness_contract.proto\x12\bprotocol\"N\n" +
	...
	"\n" +
	"vote_count\x18\x02 \x01(\x03R\tvoteCountB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_witness_contract_proto_rawDescOnce sync.Once
	file_witness_contract_proto_rawDescData []byte
)

func file_witness_contract_proto_rawDescGZIP() []byte {
	file_witness_contract_proto_rawDescOnce.Do(func() {
		file_witness_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_witness_contract_proto_rawDesc), len(file_witness_contract_proto_rawDesc)))
	})
	return file_witness_contract_proto_rawDescData
}

var file_witness_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_witness_contract_proto_goTypes = []any{
...
var file_witness_contract_proto_depIdxs = []int32{
...
func init() { file_witness_contract_proto_init() }
func file_witness_contract_proto_init() {
	if File_witness_contract_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_witness_contract_proto_rawDesc), len(file_witness_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_witness_contract_proto_goTypes,
		DependencyIndexes: file_witness_contract_proto_depIdxs,
		MessageInfos:      file_witness_contract_proto_msgTypes,
	}.Build()
	File_witness_contract_proto = out.File
	file_witness_contract_proto_goTypes = nil
	file_witness_contract_proto_depIdxs = nil
}
