...
// 	protoc        v6.33.4
// source: exchange_contract.proto
...
func (x *ExchangeCreateContract) Reset() {
	*x = ExchangeCreateContract{}
	mi := &file_exchange_contract_proto_msgTypes[0]
...
func (*ExchangeCreateContract) Descriptor() ([]byte, []int) {
	return file_exchange_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExchangeInjectContract) Reset() {
	*x = ExchangeInjectContract{}
	mi := &file_exchange_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeInjectContract) Descriptor() ([]byte, []int) {
	return file_exchange_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExchangeWithdrawContract) Reset() {
	*x = ExchangeWithdrawContract{}
	mi := &file_exchange_contract_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeWithdrawContract) Descriptor() ([]byte, []int) {
	return file_exchange_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExchangeTransactionContract) Reset() {
	*x = ExchangeTransactionContract{}
	mi := &file_exchange_contract_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeTransactionContract) Descriptor() ([]byte, []int) {
	return file_exchange_contract_proto_rawDescGZIP(), []int{3}
}
...
var File_exchange_contract_proto protoreflect.FileDescriptor

const file_exchange_contract_proto_rawDesc = "" +
	"\n" +
	"\x17exchange_contract.proto\x12\bprotocol\"\xed\x01\n" +
	...
	"\bexpected\x18\x05 \x01(\x03R\bexpectedB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_exchange_contract_proto_rawDescOnce sync.Once
	file_exchange_contract_proto_rawDescData []byte
)

func file_exchange_contract_proto_rawDescGZIP() []byte {
	file_exchange_contract_proto_rawDescOnce.Do(func() {
		file_exchange_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_exchange_contract_proto_rawDesc), len(file_exchange_contract_proto_rawDesc)))
	})
	return file_exchange_contract_proto_rawDescData
}

var file_exchange_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_exchange_contract_proto_goTypes = []any{
...
var file_exchange_contract_proto_depIdxs = []int32{
...
func init() { file_exchange_contract_proto_init() }
func file_exchange_contract_proto_init() {
	if File_exchange_contract_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_exchange_contract_proto_rawDesc), len(file_exchange_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_exchange_contract_proto_goTypes,
		DependencyIndexes: file_exchange_contract_proto_depIdxs,
		MessageInfos:      file_exchange_contract_proto_msgTypes,
	}.Build()
	File_exchange_contract_proto = out.File
	file_exchange_contract_proto_goTypes = nil
	file_exchange_contract_proto_depIdxs = nil
}
