...
func Encode(input []byte) string { return base58.Encode(input, base58.BitcoinAlphabet) }
...
func Decode(input string) ([]byte, error) { return base58.Decode(input, base58.BitcoinAlphabet) }
