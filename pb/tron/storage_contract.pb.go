...
func (x *BuyStorageBytesContract) Reset() {
	*x = BuyStorageBytesContract{}
	mi := &file_storage_contract_proto_msgTypes[0]
...
func (*BuyStorageBytesContract) Descriptor() ([]byte, []int) {
	return file_storage_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *BuyStorageContract) Reset() {
	*x = BuyStorageContract{}
	mi := &file_storage_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuyStorageContract) Descriptor() ([]byte, []int) {
	return file_storage_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *SellStorageContract) Reset() {
	*x = SellStorageContract{}
	mi := &file_storage_contract_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SellStorageContract) Descriptor() ([]byte, []int) {
	return file_storage_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *UpdateBrokerageContract) Reset() {
	*x = UpdateBrokerageContract{}
	mi := &file_storage_contract_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateBrokerageContract) Descriptor() ([]byte, []int) {
	return file_storage_contract_proto_rawDescGZIP(), []int{3}
}
...
var File_storage_contract_proto protoreflect.FileDescriptor

const file_storage_contract_proto_rawDesc = "" +
	"\n" +
	"\x16storage_contract.proto\x12\bprotocol\"T\n" +
	...
	"\tbrokerage\x18\x02 \x01(\x05R\tbrokerageB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_storage_contract_proto_rawDescOnce sync.Once
	file_storage_contract_proto_rawDescData []byte
)

func file_storage_contract_proto_rawDescGZIP() []byte {
	file_storage_contract_proto_rawDescOnce.Do(func() {
		file_storage_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_contract_proto_rawDesc), len(file_storage_contract_proto_rawDesc)))
	})
	return file_storage_contract_proto_rawDescData
}

var file_storage_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_storage_contract_proto_goTypes = []any{
...
var file_storage_contract_proto_depIdxs = []int32{
...
func init() { file_storage_contract_proto_init() }
func file_storage_contract_proto_init() {
	if File_storage_contract_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_storage_contract_proto_rawDesc), len(file_storage_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_storage_contract_proto_goTypes,
		DependencyIndexes: file_storage_contract_proto_depIdxs,
		MessageInfos:      file_storage_contract_proto_msgTypes,
	}.Build()
	File_storage_contract_proto = out.File
	file_storage_contract_proto_goTypes = nil
	file_storage_contract_proto_depIdxs = nil
}
