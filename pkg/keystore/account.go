...
type Wallet interface {
	...
	// the account in a keystore).
	SignTx(account Account, tx *tronpb.Transaction) (*tronpb.Transaction, error)

	// SignTxWithPassphrase is identical to SignTx, but also takes a password
	SignTxWithPassphrase(account Account, passphrase string, tx *tronpb.Transaction) (*tronpb.Transaction, error)
}
...
// WalletEvent departure is detected.
