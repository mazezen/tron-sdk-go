...
func (x *AccountCreateContract) Reset() {
	*x = AccountCreateContract{}
	mi := &file_account_contract_proto_msgTypes[0]
...
func (*AccountCreateContract) Descriptor() ([]byte, []int) {
	return file_account_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *AccountUpdateContract) Reset() {
	*x = AccountUpdateContract{}
	mi := &file_account_contract_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountUpdateContract) Descriptor() ([]byte, []int) {
	return file_account_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetAccountIdContract) Reset() {
	*x = SetAccountIdContract{}
	mi := &file_account_contract_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetAccountIdContract) Descriptor() ([]byte, []int) {
	return file_account_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *AccountPermissionUpdateContract) Reset() {
	*x = AccountPermissionUpdateContract{}
	mi := &file_account_contract_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountPermissionUpdateContract) Descriptor() ([]byte, []int) {
	return file_account_contract_proto_rawDescGZIP(), []int{3}
}
...
var File_account_contract_proto protoreflect.FileDescriptor

const file_account_contract_proto_rawDesc = "" +
	"\n" +
	"\x16account_contract.proto\x12\bprotocol\x1a\n" +
	"Tron.proto\"\x90\x01\n" +
	...
	"\aactives\x18\x04 \x03(\v2\x14.protocol.PermissionR\aactivesB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"

var (
	file_account_contract_proto_rawDescOnce sync.Once
	file_account_contract_proto_rawDescData []byte
)

func file_account_contract_proto_rawDescGZIP() []byte {
	file_account_contract_proto_rawDescOnce.Do(func() {
		file_account_contract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_account_contract_proto_rawDesc), len(file_account_contract_proto_rawDesc)))
	})
	return file_account_contract_proto_rawDescData
}

var file_account_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_account_contract_proto_goTypes = []any{
...
var file_account_contract_proto_depIdxs = []int32{
...
func init() { file_account_contract_proto_init() }
func file_account_contract_proto_init() {
	if File_account_contract_proto != nil {
		return
	}
	file_Tron_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_account_contract_proto_rawDesc), len(file_account_contract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_account_contract_proto_goTypes,
		DependencyIndexes: file_account_contract_proto_depIdxs,
		MessageInfos:      file_account_contract_proto_msgTypes,
	}.Build()
	File_account_contract_proto = out.File
	file_account_contract_proto_goTypes = nil
	file_account_contract_proto_depIdxs = nil
}
