...
// EthHex get bytes from address in string
func (a Address) EthHex() string {
	return common.BytesToEthHexString(a[:])
}
...
// HexToBase58Address return base58 address by give hex address
func HexToBase58Address(hex string) string {
	if hex == "" {
		return ""
	}
