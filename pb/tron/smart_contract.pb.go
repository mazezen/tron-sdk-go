...
func (SmartContract_ABI_Entry_EntryType) Descriptor() protoreflect.EnumDescriptor {
	return file_smart_contract_proto_enumTypes[0].Descriptor()
}

func (SmartContract_ABI_Entry_EntryType) Type() protoreflect.EnumType {
	return &file_smart_contract_proto_enumTypes[0]
}
...
func (SmartContract_ABI_Entry_EntryType) EnumDescriptor() ([]byte, []int) {
	return file_smart_contract_proto_rawDescGZIP(), []int{0, 0, 0, 0}
}
...
func (SmartContract_ABI_Entry_StateMutabilityType) Descriptor() protoreflect.EnumDescriptor {
	return file_smart_contract_proto_enumTypes[1].Descriptor()
}

func (SmartContract_ABI_Entry_StateMutabilityType) Type() protoreflect.EnumType {
	return &file_smart_contract_proto_enumTypes[1]
}
...
func (SmartContract_ABI_Entry_StateMutabilityType) EnumDescriptor() ([]byte, []int) {
	return file_smart_contract_proto_rawDescGZIP(), []int{0, 0, 0, 1}
}
...
func (*SmartContract_ABI) Descriptor() ([]byte, []int) {
	return file_smart_contract_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*SmartContract_ABI_Entry) Descriptor() ([]byte, []int) {
	return file_smart_contract_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (x *SmartContract_ABI_Entry_Param) Reset() {
	*x = SmartContract_ABI_Entry_Param{}
	mi := &file_smart_contract_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_smart_contract_proto_rawDesc = "" +
	"\n" +
	"\x14smart_contract.proto\x12\bprotocol\"\xa0\t\n" +
	"\rSmartContract\x12%\n" +
	...
	"\x0econtract_state\x18\x03 \x01(\v2\x17.protocol.ContractStateR\rcontractStateB*Z(github.com/mazezen/tron-sdk-go/pb/tronpbb\x06proto3"
...
var file_smart_contract_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_smart_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_smart_contract_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_smart_contract_proto_enumTypes,
